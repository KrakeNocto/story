...
wget -O story_testnet_1620492.tar.lz4 https://support.synergynodes.com/snapshots/story_testnet_story/story_testnet_1532088.tar.lz4
lz4 -c -d story_testnet_geth_1620492.tar.lz4 | tar -x -C $HOME/.story/story
rm story_testnet_1620492.tar.lz4
